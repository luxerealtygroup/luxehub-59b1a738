...
const CMABoss = () => {
  ...
  const fetchReports = async () => {
    ...
    const { data, error } = await supabase
      .from('cma_reports')
      .select('id, property_address, city_area, property_type, analysis_status, cma_grade, pricing_band_recommended, created_at, strategy_recommendation')
